...
impl Potion {
    ...
    pub fn from_id(id: u8) -> Option<&'static Self> {
        match id {
            3u8 => Some(&Self::AWKWARD),
            11u8 => Some(&Self::FIRE_RESISTANCE),
            26u8 => Some(&Self::HARMING),
            24u8 => Some(&Self::HEALING),
            45u8 => Some(&Self::INFESTED),
            6u8 => Some(&Self::INVISIBILITY),
            8u8 => Some(&Self::LEAPING),
            12u8 => Some(&Self::LONG_FIRE_RESISTANCE),
            7u8 => Some(&Self::LONG_INVISIBILITY),
            9u8 => Some(&Self::LONG_LEAPING),
            5u8 => Some(&Self::LONG_NIGHT_VISION),
            29u8 => Some(&Self::LONG_POISON),
            32u8 => Some(&Self::LONG_REGENERATION),
            41u8 => Some(&Self::LONG_SLOW_FALLING),
            17u8 => Some(&Self::LONG_SLOWNESS),
            35u8 => Some(&Self::LONG_STRENGTH),
            14u8 => Some(&Self::LONG_SWIFTNESS),
            20u8 => Some(&Self::LONG_TURTLE_MASTER),
            23u8 => Some(&Self::LONG_WATER_BREATHING),
            38u8 => Some(&Self::LONG_WEAKNESS),
            39u8 => Some(&Self::LUCK),
            1u8 => Some(&Self::MUNDANE),
            4u8 => Some(&Self::NIGHT_VISION),
            44u8 => Some(&Self::OOZING),
            28u8 => Some(&Self::POISON),
            31u8 => Some(&Self::REGENERATION),
            40u8 => Some(&Self::SLOW_FALLING),
            16u8 => Some(&Self::SLOWNESS),
            34u8 => Some(&Self::STRENGTH),
            27u8 => Some(&Self::STRONG_HARMING),
            25u8 => Some(&Self::STRONG_HEALING),
            10u8 => Some(&Self::STRONG_LEAPING),
            30u8 => Some(&Self::STRONG_POISON),
            33u8 => Some(&Self::STRONG_REGENERATION),
            18u8 => Some(&Self::STRONG_SLOWNESS),
            36u8 => Some(&Self::STRONG_STRENGTH),
            15u8 => Some(&Self::STRONG_SWIFTNESS),
            21u8 => Some(&Self::STRONG_TURTLE_MASTER),
            13u8 => Some(&Self::SWIFTNESS),
            2u8 => Some(&Self::THICK),
            19u8 => Some(&Self::TURTLE_MASTER),
            0u8 => Some(&Self::WATER),
            22u8 => Some(&Self::WATER_BREATHING),
            37u8 => Some(&Self::WEAKNESS),
            43u8 => Some(&Self::WEAVING),
            42u8 => Some(&Self::WIND_CHARGED),
            _ => None,
        }
    }
}
